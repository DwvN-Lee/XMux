...
This archive keeps detailed implementation and hotfix history before the 1.3.0
distribution baseline. The active changelog focuses on stable user-facing
release notes.
